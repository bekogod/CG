...
GLuint vertexCount, vertices, buffers[2];
...
void prepareCilinder(float height, float radius, int sides) {
	...
	glBufferData(GL_ARRAY_BUFFER,vertexCount * sizeof(float) * 3, v, GL_STATIC_DRAW);
	glBindBuffer(GL_ARRAY_BUFFER,buffers[1]);
	glBufferData(GL_ARRAY_BUFFER, vertexCount * sizeof(float) * 3, n,GL_STATIC_DRAW);
...
void renderScene(void) {
	...
	float white[] = { 0.8, 0.2, 0.3, 1.0 };
	float blue[] = { 0.4, 0.3, 0.9, 1.0 };
